...
class SysWjDict(models.Model):
    wjf = models.CharField(max_length=10, blank=True, null=True)
    wjbz = models.CharField(max_length=1, blank=True, null=True)
    bz1 = models.CharField(max_length=100, blank=True, null=True)
    bz2 = models.CharField(max_length=100, blank=True, null=True)
    bz3 = models.CharField(max_length=100, blank=True, null=True)
...
class TmpAttendInfo(models.Model):
    bill_code = models.CharField(max_length=12, blank=True, null=True)
    status = models.CharField(max_length=1, blank=True, null=True)
    zdbm = models.CharField(max_length=6, blank=True, null=True)
    kqsj = models.DateField(blank=True, null=True)
    kqy = models.CharField(max_length=4, blank=True, null=True)
    zdr = models.CharField(max_length=6, blank=True, null=True)
    zdsj = models.DateField(blank=True, null=True)
    bmshr = models.CharField(max_length=6, blank=True, null=True)
    bmshsj = models.DateField(blank=True, null=True)
    bmshyj = models.CharField(max_length=64, blank=True, null=True)
    bz = models.CharField(max_length=64, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'tmp_attend_info'


class TmpAttendInfos(models.Model):
    bill_code = models.CharField(max_length=12, blank=True, null=True)
    jjgbh = models.CharField(max_length=6, blank=True, null=True)
    sxh = models.FloatField(blank=True, null=True)
    cqlx = models.CharField(max_length=2, blank=True, null=True)
    jjlx = models.CharField(max_length=6, blank=True, null=True)
    gtwcsl = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    hhrs = models.FloatField(blank=True, null=True)
    zsdgs = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    jjydgz = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    ykje = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'tmp_attend_infos'


class TmpEinfor(models.Model):
    jjgbh = models.CharField(max_length=6, blank=True, null=True)
    xm = models.CharField(max_length=20, blank=True, null=True)
    xb = models.CharField(max_length=1, blank=True, null=True)
    csrq = models.DateField(blank=True, null=True)
    mz = models.CharField(max_length=2, blank=True, null=True)
    jhf = models.CharField(max_length=1, blank=True, null=True)
    sfzh = models.CharField(max_length=20, blank=True, null=True)
    jtdz = models.CharField(max_length=128, blank=True, null=True)
    lxdh = models.CharField(max_length=40, blank=True, null=True)
    jkzk = models.CharField(max_length=6, blank=True, null=True)
    ssbm = models.CharField(max_length=6, blank=True, null=True)
    ssgw = models.CharField(max_length=6, blank=True, null=True)
    qldhtf = models.CharField(max_length=1, blank=True, null=True)
    qldhtsj = models.DateField(blank=True, null=True)
    cjaqpxf = models.CharField(max_length=1, blank=True, null=True)
    apzsf = models.CharField(max_length=1, blank=True, null=True)
    bcrzf = models.CharField(max_length=1, blank=True, null=True)
    bjszf = models.CharField(max_length=1, blank=True, null=True)
    jszhm = models.CharField(max_length=20, blank=True, null=True)
    yhzh = models.CharField(max_length=20, blank=True, null=True)
    lbf = models.CharField(max_length=1, blank=True, null=True)
    bz = models.CharField(max_length=255, blank=True, null=True)
    jjgzt = models.CharField(max_length=1, blank=True, null=True)
    bzpym = models.CharField(max_length=10, blank=True, null=True)
    lry = models.CharField(max_length=6, blank=True, null=True)
    lrsj = models.DateField(blank=True, null=True)
...
class TmpLcInfo(models.Model):
    dm = models.CharField(max_length=8, blank=True, null=True)
    jjgbh = models.CharField(max_length=6, blank=True, null=True)
    htqssj = models.DateField(blank=True, null=True)
    htzzsj = models.DateField(blank=True, null=True)
    htqdsj = models.DateField(blank=True, null=True)
    htjdsj = models.DateField(blank=True, null=True)
    htjddw = models.CharField(max_length=64, blank=True, null=True)
    yxf = models.CharField(max_length=1, blank=True, null=True)
    htjcsj = models.DateField(blank=True, null=True)
    htjclx = models.CharField(max_length=2, blank=True, null=True)
    bz = models.CharField(max_length=128, blank=True, null=True)
    lry = models.CharField(max_length=6, blank=True, null=True)
    lrsj = models.DateField(blank=True, null=True)
    qxr = models.CharField(max_length=6, blank=True, null=True)
    qxsj = models.DateField(blank=True, null=True)
    qxdm = models.CharField(max_length=8, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'tmp_lc_info'


class TmpPayInfos(models.Model):
    bill_code = models.CharField(max_length=12, blank=True, null=True)
    jjgbh = models.CharField(max_length=6, blank=True, null=True)
    gzxm = models.CharField(max_length=2, blank=True, null=True)
    sl = models.FloatField(blank=True, null=True)
    yfje = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'tmp_pay_infos'


class TmpPstru(models.Model):
    dm = models.CharField(max_length=2, blank=True, null=True)
    mc = models.CharField(max_length=64, blank=True, null=True)
    ffbz = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    jslx = models.CharField(max_length=1, blank=True, null=True)
    kgrsf = models.CharField(max_length=1, blank=True, null=True)
    kkbj = models.CharField(max_length=1, blank=True, null=True)
    sjdm = models.CharField(max_length=10, blank=True, null=True)
    jb = models.FloatField(blank=True, null=True)
    yzjf = models.CharField(max_length=1, blank=True, null=True)
    bzpym = models.CharField(max_length=10, blank=True, null=True)
...
class TmpRequInfo(models.Model):
    sqbm = models.CharField(max_length=6, blank=True, null=True)
    sqsj = models.DateField(blank=True, null=True)
    sqzgbm = models.CharField(max_length=6, blank=True, null=True)
    shgs = models.FloatField(blank=True, null=True)
    ygrs = models.FloatField(blank=True, null=True)
    ygqx = models.CharField(max_length=20, blank=True, null=True)
    ygdd = models.CharField(max_length=64, blank=True, null=True)
    ygsx = models.CharField(max_length=64, blank=True, null=True)
    gsys = models.CharField(max_length=128, blank=True, null=True)
    jjgzgspyj = models.CharField(max_length=64, blank=True, null=True)
    jjgzgdm = models.CharField(max_length=6, blank=True, null=True)
    jjgzgspsj = models.DateField(blank=True, null=True)
    rlzyspyj = models.CharField(max_length=64, blank=True, null=True)
    rlzyzgdm = models.CharField(max_length=6, blank=True, null=True)
    rlzyspsj = models.DateField(blank=True, null=True)
    sjzgspyj = models.CharField(max_length=64, blank=True, null=True)
    sjzgdm = models.CharField(max_length=6, blank=True, null=True)
    sjzgspsj = models.DateField(blank=True, null=True)
    bz = models.CharField(max_length=255, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'tmp_requ_info'


class TransBasCustInfor(models.Model):
    cid = models.CharField(max_length=12, blank=True, null=True)
    xm = models.CharField(max_length=50, blank=True, null=True)
    xb = models.CharField(max_length=1, blank=True, null=True)
    csrq = models.DateField(blank=True, null=True)
    ...
    cust_type = models.CharField(max_length=6, blank=True, null=True)
    zwdm = models.CharField(max_length=12, blank=True, null=True)
    cw = models.CharField(max_length=20, blank=True, null=True)
    zycd = models.CharField(max_length=20, blank=True, null=True)
    hycd = models.CharField(max_length=20, blank=True, null=True)
    khly = models.CharField(max_length=6, blank=True, null=True)
    zhye = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    member_type = models.CharField(max_length=2, blank=True, null=True)
    card_code = models.CharField(max_length=12, blank=True, null=True)
    ...
    txtz = models.CharField(max_length=150, blank=True, null=True)
    yxjb = models.CharField(max_length=2, blank=True, null=True)
    cust_region = models.CharField(max_length=1, blank=True, null=True)
    k3_item = models.CharField(max_length=80, blank=True, null=True)
    k3_zg_item = models.CharField(max_length=20, blank=True, null=True)
    bgd_lb = models.CharField(max_length=1, blank=True, null=True)
    grgz_ye = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    zzys = models.CharField(max_length=6, blank=True, null=True)
    xgsj = models.DateField(blank=True, null=True)
    user_password = models.CharField(max_length=20, blank=True, null=True)
    password_xgsj = models.DateField(blank=True, null=True)
    zzhs = models.CharField(max_length=6, blank=True, null=True)
    billcode = models.CharField(max_length=200, blank=True, null=True)
    bcsj = models.DateField(blank=True, null=True)
    m_trans_status = models.CharField(max_length=10, blank=True, null=True)
    oldid = models.CharField(max_length=200, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'trans_bas_cust_infor'


class TransJjSfmxb(models.Model):
    sfmxid = models.CharField(max_length=14, blank=True, null=True)
    vid = models.CharField(max_length=12, blank=True, null=True)
    cid = models.CharField(max_length=12, blank=True, null=True)
    groupid = models.CharField(max_length=10, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'trans_jj_sfmxb'


class TransJjYyqkb(models.Model):
    vid = models.CharField(max_length=12, blank=True, null=True)
    cid = models.CharField(max_length=12, blank=True, null=True)
    dwdm = models.CharField(max_length=12, blank=True, null=True)
    yysj = models.DateField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'trans_jj_yyqkb'


class TransPrimrayInformation(models.Model):
    vid = models.CharField(max_length=20, blank=True, null=True)
    cid = models.CharField(max_length=20, blank=True, null=True)
    djsj = models.DateField(blank=True, null=True)
    bz1 = models.CharField(max_length=50, blank=True, null=True)
    ...
    bz3 = models.CharField(max_length=50, blank=True, null=True)
    bz4 = models.CharField(max_length=50, blank=True, null=True)
    bz5 = models.CharField(max_length=50, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'trans_primray_information'


class TransSysDataComplete(models.Model):
    code_value = models.CharField(max_length=30, blank=True, null=True)
    lb = models.CharField(max_length=2, blank=True, null=True)
    trans_status = models.CharField(max_length=1, blank=True, null=True)
    op_datetime = models.DateField(blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'trans_sys_data_complete'


class XwyyRsfbList(models.Model):
    in_factory = models.CharField(max_length=20, blank=True, null=True)
    rq = models.CharField(max_length=20, blank=True, null=True)
    lb = models.CharField(max_length=20, blank=True, null=True)
...
class YjptTransList(models.Model):
    vid = models.CharField(max_length=20, blank=True, null=True)
    item_id = models.CharField(max_length=20, blank=True, null=True)
    in_factory = models.CharField(max_length=20, blank=True, null=True)
    lb = models.CharField(max_length=10, blank=True, null=True)
    djsj = models.DateField(blank=True, null=True)
    local_status = models.CharField(max_length=1, blank=True, null=True)
    remote_status = models.CharField(max_length=1, blank=True, null=True)
    bz1 = models.CharField(max_length=50, blank=True, null=True)
    bz2 = models.CharField(max_length=50, blank=True, null=True)
    item_name = models.CharField(max_length=100, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'yjpt_trans_list'


class YyAddItem(models.Model):
    vid = models.CharField(max_length=20, blank=True, null=True)
    groupid = models.CharField(max_length=100, blank=True, null=True)
    groupname = models.CharField(max_length=200, blank=True, null=True)
    member_price = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'yy_add_item'


class YyDhyyAfterDo(models.Model):
    id = models.CharField(max_length=200, blank=True, null=True)
    do_sql = models.CharField(max_length=2000, blank=True, null=True)
    bz1 = models.CharField(max_length=200, blank=True, null=True)
    bz2 = models.CharField(max_length=200, blank=True, null=True)
    status = models.CharField(max_length=10, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'yy_dhyy_after_do'


class YyFactoryGroupLimit(models.Model):
    billcode = models.CharField(max_length=30, blank=True, null=True)
    groupid = models.CharField(max_length=30, blank=True, null=True)
    in_factory = models.CharField(max_length=30, blank=True, null=True)
    bz1 = models.CharField(max_length=30, blank=True, null=True)
    bz2 = models.CharField(max_length=30, blank=True, null=True)
    bz3 = models.CharField(max_length=30, blank=True, null=True)
    bz4 = models.CharField(max_length=30, blank=True, null=True)
    groupname = models.CharField(max_length=200, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'yy_factory_group_limit'


class YyFactoryItemDict(models.Model):
    in_factory = models.CharField(max_length=30, blank=True, null=True)
    lb = models.CharField(max_length=10, blank=True, null=True)
...
class YyItemRsControl(models.Model):
    rq = models.CharField(max_length=10, blank=True, null=True)
    in_factory = models.CharField(max_length=20, blank=True, null=True)
    lb = models.CharField(max_length=100, blank=True, null=True)
    kyyrs = models.BigIntegerField(blank=True, null=True)
    yyyrs = models.BigIntegerField(blank=True, null=True)
    lx = models.CharField(max_length=5, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'yy_item_rs_control'


class YyJtParam2018(models.Model):
    in_factory = models.CharField(max_length=10, blank=True, null=True)
    vip = models.CharField(max_length=10, blank=True, null=True)
    dz = models.CharField(max_length=500, blank=True, null=True)
    lxdh = models.CharField(max_length=100, blank=True, null=True)
    je = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
    bz1 = models.CharField(max_length=50, blank=True, null=True)
    ...
    bz4 = models.CharField(max_length=50, blank=True, null=True)
    bz5 = models.CharField(max_length=50, blank=True, null=True)
    bz6 = models.CharField(max_length=50, blank=True, null=True)
    bz7 = models.CharField(max_length=50, blank=True, null=True)
    bz8 = models.CharField(max_length=50, blank=True, null=True)
    bz9 = models.CharField(max_length=50, blank=True, null=True)
    bz10 = models.CharField(max_length=50, blank=True, null=True)
    sz1 = models.IntegerField(blank=True, null=True)
    sz2 = models.IntegerField(blank=True, null=True)
    sz3 = models.IntegerField(blank=True, null=True)
    sz4 = models.IntegerField(blank=True, null=True)
    sz5 = models.IntegerField(blank=True, null=True)
    sz6 = models.IntegerField(blank=True, null=True)
    sz7 = models.IntegerField(blank=True, null=True)
    sz8 = models.IntegerField(blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'yy_jt_param2018'


class YypqJzTemp(models.Model):
    vid = models.CharField(max_length=20, blank=True, null=True)
    yysj = models.DateField(blank=True, null=True)
    in_factory = models.CharField(max_length=30, blank=True, null=True)
    dwdm = models.CharField(max_length=30, blank=True, null=True)
...
class ZjCustFp(models.Model):
    vid = models.CharField(max_length=20, blank=True, null=True)
    checkoper = models.CharField(max_length=30, blank=True, null=True)
...
class ZjGlDict2018(models.Model):
    dm = models.CharField(max_length=10, blank=True, null=True)
    mc = models.CharField(max_length=200, blank=True, null=True)
    sxh = models.IntegerField(blank=True, null=True)
    bz1 = models.CharField(max_length=50, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'zj_gl_dict2018'


class ZjGlDictList2018(models.Model):
    dm = models.CharField(max_length=10, blank=True, null=True)
    item_id = models.CharField(max_length=30, blank=True, null=True)
    sxh = models.IntegerField(blank=True, null=True)
    bz1 = models.CharField(max_length=100, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'zj_gl_dict_list2018'


class ZjGlVidList(models.Model):
    vid = models.CharField(max_length=20, blank=True, null=True)
    czsj = models.DateField(blank=True, null=True)
    czy = models.CharField(max_length=50, blank=True, null=True)
    czyname = models.CharField(max_length=100, blank=True, null=True)
    bz1 = models.CharField(max_length=100, blank=True, null=True)
    bz2 = models.CharField(max_length=100, blank=True, null=True)
    bz3 = models.CharField(max_length=100, blank=True, null=True)
...
class ZkccdCzb(models.Model):
    item_id = models.CharField(max_length=30, blank=True, null=True)
    partid = models.CharField(max_length=10, blank=True, null=True)
...
#
# class ZybHkFeeImport(models.Model):
#     billcode = models.CharField(max_length=200, blank=True, null=True)
#     hk_id = models.CharField(max_length=100, blank=True, null=True)
#     dwdm = models.CharField(max_length=50, blank=True, null=True)
#     dwmc = models.CharField(max_length=200, blank=True, null=True)
#     hk_dwdm = models.CharField(max_length=50, blank=True, null=True)
#     rq = models.CharField(max_length=10, blank=True, null=True)
#     rs = models.IntegerField(blank=True, null=True)
#     xj = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
#     xyk = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
#     gz = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
#     ybk = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
#     wx = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
#     zfb = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
#     yhzz = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
#     zp = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
#     qt = models.DecimalField(max_digits=12, decimal_places=2, blank=True, null=True)
#     status = models.CharField(max_length=1, blank=True, null=True)
#     lrry = models.CharField(max_length=100, blank=True, null=True)
#     lrsj = models.DateField(blank=True, null=True)
#     shry = models.CharField(max_length=100, blank=True, null=True)
...
# class ZzjJpInfo(models.Model):
#     itemid = models.CharField(max_length=6, blank=True, null=True)
#     itemname = models.CharField(max_length=40, blank=True, null=True)
#     itemtype = models.CharField(max_length=10, blank=True, null=True)
#     jpsl = models.BigIntegerField(blank=True, null=True)
#     jpje = models.FloatField(blank=True, null=True)
#     factory = models.CharField(max_length=5, blank=True, null=True)
#     bz1 = models.CharField(max_length=50, blank=True, null=True)
#     bz2 = models.CharField(max_length=50, blank=True, null=True)
#     bz3 = models.CharField(max_length=50, blank=True, null=True)
#     bz4 = models.CharField(max_length=50, blank=True, null=True)
...
#     class Meta:
#         managed = False
#         db_table = 'zzj_jp_info'
#
#
# class ZzjJsmxb(models.Model):
#     orderno = models.CharField(max_length=30, blank=True, null=True)
#     factory = models.CharField(max_length=3, blank=True, null=True)
#     paytype = models.CharField(max_length=3, blank=True, null=True)
#     cid = models.CharField(max_length=20, blank=True, null=True)
#     vid = models.CharField(max_length=20, blank=True, null=True)
#     xm = models.CharField(max_length=50, blank=True, null=True)
#     xb = models.CharField(max_length=2, blank=True, null=True)
#     sfzhm = models.CharField(max_length=18, blank=True, null=True)
#     ispay = models.CharField(max_length=1, blank=True, null=True)
#     isoperate = models.CharField(max_length=1, blank=True, null=True)
#     amount = models.DecimalField(max_digits=24, decimal_places=4, blank=True, null=True)
#     createdate = models.DateField(blank=True, null=True)
#     createuser = models.CharField(max_length=10, blank=True, null=True)
#     payid = models.CharField(max_length=32, blank=True, null=True)
#     paydate = models.DateField(blank=True, null=True)
#     operatedate = models.DateField(blank=True, null=True)
#     operateuser = models.CharField(max_length=10, blank=True, null=True)
#     operateusername = models.CharField(max_length=50, blank=True, null=True)
#     status = models.CharField(max_length=1, blank=True, null=True)
#     statusdate = models.DateField(blank=True, null=True)
#     trans_status = models.CharField(max_length=1, blank=True, null=True)
#     equipmentid = models.CharField(max_length=50, blank=True, null=True)
#     bz = models.CharField(max_length=200, blank=True, null=True)
#     bz1 = models.CharField(max_length=50, blank=True, null=True)
#     bz2 = models.CharField(max_length=50, blank=True, null=True)
#     bz3 = models.CharField(max_length=50, blank=True, null=True)
...
#
# class ZzjJsmxbDetail(models.Model):
...
#     costs = models.DecimalField(max_digits=24, decimal_places=2, blank=True, null=True)
#     printtime = models.DateField(blank=True, null=True)
#     factory = models.CharField(max_length=50, blank=True, null=True)
#     equipmentid = models.CharField(max_length=50, blank=True, null=True)
#     memo1 = models.CharField(max_length=50, blank=True, null=True)
#     memo2 = models.CharField(max_length=50, blank=True, null=True)
#     memo3 = models.CharField(max_length=50, blank=True, null=True)
#     memo4 = models.CharField(max_length=50, blank=True, null=True)
#     memo5 = models.CharField(max_length=50, blank=True, null=True)
#
#     class Meta:
#         managed = False
#         db_table = 'zzj_jsmxb_detail'
